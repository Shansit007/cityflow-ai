...
def main() -> int:
    ...
    # Beside the scenario, not in docs/results. run_sweep.py covers this adoption level
    # among six others and is what the documentation quotes; a second committed file
    # saying the same thing is one more place for the two to drift apart.
